...
If you have any more questions about Lancero, a possible integration or a feature you would love to see. Feel free to send us an email at <a>support@lancero.app</a> or a <a href={'https://twitter.com/messages/compose?recipient_id=1442805578406010884'}>DM @joinlancero on Twitter</a>
...
## How does it work?
Below you can find a flowchart of a possible implemenation of Lancero. This is just an example of how we would use it but don't worry, any intergration that suits your needs is fine with us!
<Image src={flowchart} alt="Hello" layout={'responsive'} placeholder={'blur'} width={4696} height={2724} />